module Advent.TwentySixteen.Eleven(main) where
...
parseInput :: Parser Word32
parseInput = (.|. elevatorAt 0) . combineStates <$> pLines pLine
...
main :: IO ()
main = defaultMain "2016.11" parseInput $ \input ->
  print input
